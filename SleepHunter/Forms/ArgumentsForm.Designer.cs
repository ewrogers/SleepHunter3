...
namespace SleepHunter.Forms
{
    partial class ArgumentsForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            | System.Windows.Forms.AnchorStyles.Right)));
            this.numericComparisonGroupBox.Controls.Add(this.percentLabel);
            ...
            this.stringValueTextBox.TextChanged += new System.EventHandler(this.textBox_TextChanged);
            // 
            ...
            this.keystrokesTextbox.TextChanged += new System.EventHandler(this.textBox_TextChanged);
            // 
            // argsAnchorPanel
            // 
            ...
            0,
            0});
            this.waitNumeric.Minimum = new decimal(new int[] {
            1,
            0,
            0,
            0});
            ...
            this.waitNumeric.Value = new decimal(new int[] {
            1,
            0,
            0,
            0});
            ...
            this.stringInputTextBox.TextChanged += new System.EventHandler(this.textBox_TextChanged);
            // 
            // stringInputLabel
            // 
