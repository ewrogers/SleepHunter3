          ...
          foreach (frmMacro.KeystrokeItem keystrokeItem in keystrokeItemArray)
          {
            ...
            else
            {
              ...
              if (num3 != (short) -1 & num3 != short.MaxValue)
                frmMacro.User32.PostMessage((IntPtr) (long) this.memRead.WindowHandle, 256U /*0x0100*/, (UIntPtr) (ulong) num3, (UIntPtr) ((ulong) this.MakeDWord((short) 0, (short) frmMacro.User32.MapVirtualKey((uint) num3, 0U)) | (ulong) num1));
            }
          }
        }
        return LineNo + 1;
